...
Generated 2026-09-24 10:57Z. R is gross, before fees and slippage. Not evidence of an edge. Scores the engine's calls against later closed candles.
...
| --- | --- | --- | --- | --- | --- | --- |
| [NO SCORED CALLS YET] | 0 | – | 0 / 0 | 0 | – | 2026-09-24 10:57Z |
...
| WATCH | 24 | 8 | 37.5% | +0.48R | 3 / 5 | 5 | 7 | 4 | 0 / 8 | FILTER MAY BE BLOCKING WINNERS |
| BAD | 30 | 6 | 66.7% | +0.36R | 4 / 2 | 3 | 5 | 16 | 6 / 0 | FILTER MAY BE BLOCKING WINNERS |
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-24 10:57Z | BTC | WATCH | 1m | long | 83513.3 / 83409.7 / 83913.196 | pending |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BAD | 30 | 8 | 4 | 2 | 3 | 66.7% | +0.36R | 0.68 | 2 | 6 |
| WATCH | 24 | 12 | 3 | 5 | 5 | 37.5% | +0.48R | – | 5 | 35 |

By reason:

| Reason | Calls | Fills | TP1 | Stop | Open | Win rate | Exp. (gross R) | Avg net R:R (plan) | Max loss streak | Median min to TP1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| need_confirmed_flag_plan | 24 | 12 | 3 | 5 | 5 | 37.5% | +0.48R | – | 5 | 35 |
...
Captures 126, gaps 21, DATA_UNAVAILABLE 0, mark drift |bps| median 2.05 / max 13, missing 1m candles 0.
